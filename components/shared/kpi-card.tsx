...
export function KpiCard({ item }: { item: KpiCardType; index?: number }) {
  ...
  const content = (
    <div className="group h-full">
      <div className="relative flex h-full min-h-[166px] flex-col overflow-hidden rounded-[22px] border border-slate-200/80 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition duration-200 group-hover:-translate-y-0.5 group-hover:border-blue-200 group-hover:shadow-[0_18px_38px_rgba(15,23,42,0.10)]">
        <div
          className={cn(
        ...
        {item.change ? (
          <p
            className={cn(
              "relative mt-auto flex items-center gap-1.5 pt-3 text-xs font-semibold",
